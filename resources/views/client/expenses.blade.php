...
<div class="container-dashboard">
    <h4 class="font-weight-bold gradient-secondary">Expenses</h4>
    <div>
        <canvas id="expenseChart" width="400" height="400"></canvas>
    </div>
</div>
<div class="container-dashboard">
    <h4 class="font-weight-bold text-gradient">Detail Expenses</h4>
    <table class="table">
        <thead>
            <tr>
                <th>No</th>
        ...
        <tbody>
            ...
            @foreach ($earnings as $earning)
                <tr>
                    ...
                    <td class="text-danger">- {{ $earning->amount }}</td>
                </tr>
            @endforeach
        </tbody>
    </table>
